...
// arc (see CLAUDE.md "24-level mapping" — confirmed with the user before
// implementation, 2026-06-19). `title` is the kid-facing celebratory name
// (keeps the space/Nova motif); `stage` is the real grammar milestone,
// useful on parent/teacher dashboards wanting to know what skill is active.
// Level is still XP-gated for now — see CLAUDE.md note on what this remap
// does and doesn't cover (curriculum-content sequencing per level is a
// separate, larger undertaking not included here).
const LEVELS = [
